...
description:
- get data from https://www.odsluchane.eu/ and save to the data lake
"""
...
# import packages for azure data lake integration
...
# hardcoded parameters for Azure Data Lake storage
...
sa_parent_directory_name = "raw-demo"
...
# main url: https://www.odsluchane.eu/szukaj.php?r=3&date=05-05-2021&time_from=4&time_to=6
